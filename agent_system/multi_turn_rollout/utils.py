...
def filter_group_data(batch_list : List[Dict],
    ...
    # delete corresponding logits
    # logprobs_list = [logprobs_list[i] for i in keep_indices]
    logprobs_list = [logprobs_list[i] for i in keep_indices]
    # logprobs_list = logprobs_list[keep_indices]

    return batch_list, episode_rewards, episode_lengths, success, traj_uid, logprobs_list
